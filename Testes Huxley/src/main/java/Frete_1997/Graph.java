            ...
            if(this.visited[current[1]] == 0){
                ...
                for(int a  = 1; a < this.size; a++){
                    if(this.edges[current[1]][a] != 0){
                        if(this.dist[current[1]] + this.edges[current[1]][a] <= this.dist[a]){
                            this.dist[a] = this.dist[current[1]] + this.edges[current[1]][a];
                            Integer[] i = {this.dist[a], a};
                            this.path[a] = current[1];
                            queue.add(i);
                        }
                    }
                }
